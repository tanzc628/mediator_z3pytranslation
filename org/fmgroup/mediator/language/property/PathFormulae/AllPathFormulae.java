...
public class AllPathFormulae implements PathFormulae {
    ...
    @Override    public AllPathFormulae copy(RawElement parent) throws ValidationException {
        AllPathFormulae newFormulae = new AllPathFormulae();
        newFormulae.setParent(parent);
        if (this.formula != null) {
            newFormulae.setFormula((StateFormulae) this.formula.copy(newFormulae));
        }
        return newFormulae;
    }
